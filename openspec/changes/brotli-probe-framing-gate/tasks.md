...
- [ ] 5.2 Field survey of `e_lfanew` maxima and real-world WBITS on Windows/macOS via `scripts/exploration/brotli_probe_field_survey.py`, to firm up the `sfx-format-detection` cue conclusions
