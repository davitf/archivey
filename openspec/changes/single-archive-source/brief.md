...
source streams work and the bounded header allocations work both reaching main. Not
breaking: no public API changes. Effort is medium to large, since every backend moves.
