...
(see ``dev-docs/known-issues.md`` and ``_AcceleratorStream`` in ``archivey.internal.streams.codecs``).
...
``test_archivey_uses_single_accelerator_library`` below and ``dev-docs/known-issues.md``).
