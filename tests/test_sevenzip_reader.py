...
def test_filetime_conversion_and_invalid_timestamp_issue() -> None:
    ...
    dt, issue = filetime_to_datetime(132_000_000_000_000_000, "a.txt", field="modified")
    assert dt is not None and issue is None
    assert filetime_to_datetime(0, "a.txt", field="modified") == (None, None)
    assert filetime_to_datetime(None, "a.txt", field="modified") == (None, None)
    ...
    dt, issue = filetime_to_datetime(0xFFFFFFFFFFFFFFFF, "a.txt", field="created")
    assert dt is None
