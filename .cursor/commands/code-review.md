...
**status table over the previous IDs**, say which gates you re-ran yourself, and end every
comment with the `_Generated by [Claude Code](https://claude.ai/code)_` footer.
