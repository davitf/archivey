...
prose in the addendum's **§0 three-block shape**: (1) maintainer briefing, (2) paste-ready
implementor handoff ranked by severity × confidence, (3) maintainer decisions. Not a
