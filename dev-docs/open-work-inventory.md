...
| [`review/exception-catchalls/`](../review/exception-catchalls/brief.md) | 67 blind `except` sites | **Done 2026-09-25.** Six fixed, 61 fine, five deferred behind two open PRs; see its `SUMMARY.md` |
