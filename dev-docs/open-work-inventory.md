...
| --- | --- | --- |
| [#406](https://github.com/davitf/archivey/pull/406) | **Proposal only**: decode 7z BCJ2 folders, with a prototype | OpenSpec `sevenzip-bcj2-decode`; implemented and archived in a later PR |
