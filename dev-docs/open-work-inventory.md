...
| [`review/exception-catchalls/`](../review/exception-catchalls/brief.md) | 67 blind `except` sites | **Done 2026-09-25.** Six fixed, the rest fine (two deferred handlers and two added since were reviewed later); see its `SUMMARY.md` |
