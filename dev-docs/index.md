...
| Doc | Role |
| --- | --- |
| [Pair workflow](pair-workflow.md) | **Preferred everyday loop**: investigate → grill into handbook → thin brief → implement → other-agent review → decision packets. What to borrow from external skill stacks |
| [Format handbook](formats/README.md) | Living per-format pages (pilot): behaviour, consequences, light decisions, verify |
| [Topic handbook](topics/README.md) | Living cross-cutting pages (detection, safety, streaming, errors) |
