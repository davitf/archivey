...
- **Does the glob-concatenation refusal earn its keep?** It ships and is decided (§6):
  ...
  as one to revisit (davitf, [#372](https://github.com/davitf/archivey/pull/372),
  2026-09-20: "this whole rejection thing is a decision we might revisit later"),
  on two arguments that the measurement in §6 does not dispose of.
