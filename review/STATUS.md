...
| [`typing-escape-hatches/`](typing-escape-hatches/brief.md) — type-checker escape hatches in `src/` | **Commissioned 2026-09-11** at `8e88e4f`. **Inventory delivered 2026-09-17** at `94468bd0` ([`SUMMARY.md`](typing-escape-hatches/SUMMARY.md), [`inventory.md`](typing-escape-hatches/inventory.md)). 89 sites, each probed on both checkers. S1 (`CONTRIBUTING.md` suppression form) and S6 (the twelve pyrefly warnings) closed in the inventory PR. S2/S3 still closed; a third `# pyrefly: ignore[bad-override]` (`FullCountStream.name`) is the same S5b KEEP. No new #324-class TypeGuard lie. Next: staged fix PRs 1–7 in the SUMMARY (dead casts, `Any`→`object`, `_track_source_seeks` overloads, TypeGuard predicates, remaining Protocols). Public `extra: dict[str, Any]` is Q1. |
