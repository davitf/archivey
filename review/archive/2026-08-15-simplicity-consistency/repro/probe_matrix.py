...
The brief (`review/archive/2026-08-15-simplicity-consistency/brief.md`, §Suggested process step 2) asks
...
Usage::
    ...
    uv run --no-sync python review/archive/2026-08-15-simplicity-consistency/repro/probe_matrix.py
    uv run --no-sync python review/archive/2026-08-15-simplicity-consistency/repro/probe_matrix.py --json out.json
    uv run --no-sync python review/archive/2026-08-15-simplicity-consistency/repro/probe_matrix.py --formats zip,tar,7z
...
def render_markdown(targets: list[Target], unmeasured: list[str]) -> str:
    ...
    out.append(
        f"Generated by `review/archive/2026-08-15-simplicity-consistency/repro/probe_matrix.py` over "
