...
| `simplicity-consistency/` | Simplicity & consistency pass — uniform interface, accidental format/entry-point differences, spec honesty | Brief 2026-08-06; **findings delivered** (analysis-only until maintainer picks pay items). See `SUMMARY.md` / `QUESTIONS.md`. |
