...
| `PackageNotInstalledError` | an optional package or tool is absent (e.g. the RARLAB `unrar` binary for RAR data — not Homebrew `7zz` / `unar`; see [Install](install.md#getting-rarlab-unrar)) |
