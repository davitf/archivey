...
from archivey.cli_helpers import display_path, escape_control_chars
...
def escape_member_name(name: str) -> str:
    ...
    A thin alias over :func:`archivey.cli_helpers.escape_control_chars`, kept because
...
def escape_path(path: str | os.PathLike[str]) -> str:
    ...
    (:func:`archivey.cli_helpers.display_path`).
    """
