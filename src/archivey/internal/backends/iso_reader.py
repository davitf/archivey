...
def _describe_raw_sector_image(source: Path | BinaryIO) -> str | None:
    ...
    is video or audio and holds none. The sector size is where the second sync lands. A
    ``BinaryIO`` is left at the position it was handed in at.
    """
